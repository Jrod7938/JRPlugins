package com.piggyplugins.EthanApiPlugin.Collections.query;
...
public class NPCQuery {
    ...
    public NPCQuery nameContainsNoCase(String name) {
        npcs = npcs.stream().filter(npcs -> npcs.getName() != null && npcs.getName().toLowerCase().contains(name.toLowerCase())).collect(Collectors.toList());
        return this;
    }
