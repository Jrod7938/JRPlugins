...
public class AutoSulphurOverlay extends Overlay {
    private final PanelComponent panelComponent = new PanelComponent();
    private final Client client;
    private final AutoSulphurPlugin plugin;

    @Inject
    private AutoSulphurOverlay(Client client, AutoSulphurPlugin plugin) {
        this.client = client;
        this.plugin = plugin;
