...
public interface AutoVorkathConfig extends Config {
    ...
    default String LOOTNAMES() {
        return "Green dragonhide,Blue dragonhide,Superior dragon bones,Battlestaff,Diamond,Dragonstone bolt tips,Chaos rune,Black dragonhide,Dragon bones,Dragon plateskirt,Red dragonhide";
    }
